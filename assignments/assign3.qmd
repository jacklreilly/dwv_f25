...
1. Create an Quarto file (`File>>New File>>Quarto Document`). Title it "Week 3 Homework.qmd", select "HTML" output, and **uncheck** "use visual markdown editor".  (You can switch to this later.)

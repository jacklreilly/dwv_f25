...
- Recommended reference reading:
  - **FCSP** chapter 2
    - Note: *we will not cover all of this material in ch 2 this week; don't get caught up on things not in course slides or course R scripts*
  - **DMSS** chapters 1-2
...
5. Load `npsvisitation0910.csv`.  It has three variables: Park, year2009, and year2010, with the second two giving the number of vistors to the park in question in 2009 and 2010.
...
7. **BONUS**:[^:bonus] Roll one twelve sided die 1000 times.  Then, roll *two* six sided dice (together) 1000 times.  What is the mean of the twelve sided die rolls and two six sided dice rolls?  How do the *distributions* (histogram) of these two rolls differ?

[^:bonus]: This bonus is for no actual bonus points - it's just a optional problem to try to begin thinking your way through code.

...
- Read **FCSP** chapter 1 *or* **PSDS** chapter 5
...
5. Create an object named "ebullient" that stores three numbers as a vector/list: 4,5,and 6
6. Create an object named "fastidious" that stores three numbers as a vector/list: 8,9, and 11
7. Add "ebullient" and "fastidious" together, and store it in an object named "george"
8. Find the mean (average) of "fastidious", and store it in an obejct named "zoinks"

...
::: {.callout-tip}
### Tip
Remember there are multiple ways to plot political and social maps, in both base R and the tidyverse. To first approximation, there is the *pre-*`sf` data management style, where each vertex in the map would be a row/observation of your data, and also the newer `sf` style of mapping, where each polygon is a single row in your data with a multipolygon column/variable containing geographic information.  
